  ...
  return (
    <section className='c-space my-20' id='work'>
        ...
        <div className='grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full'>
            <div className='flex-col gap-5 relative sm:p-10 px-5 shadow-2xl shadow-black-200'>
                ...
                <div className='flex items-center justify-between flex-wrap gap-5'>
                    <div className='flex items-center gap-3'>
                        ...
                        <a className='flex items-center gap-2 cursor-pointer text-white-600 ' href={currentProject.href} target="_blank" rel='nonreferrer'>
                            <p>Check Live Site</p>
